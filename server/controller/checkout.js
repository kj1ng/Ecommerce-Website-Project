...
export const create_checkout_session = async (req, res) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items,
            mode: 'payment',
            success_url: 'http://localhost:3000/orders?payment_status=success', // Redirect URL after successful payment
            cancel_url: 'http://localhost:3000/orders?payment_status=failed',   // Redirect URL after canceled payment
        });
...
export const verify_payment_status = async (req, res) => {
    try {
        ...
        const verificationUrl = `http://localhost:3000/payment_confirmation_email`;
